	...
	function uf_procesar_personal_version2($ai_anocurper,$as_mescurper,$aa_nominas,$ad_fecgen,$as_codper,$ai_tipo)
	{
		...
		switch($ai_tipo)
		{
			case 0: // Calculo normal de la prestación antiguedad por nomina mes a mes
				...
				$ls_sql="SELECT sno_hpersonalnomina.codper, sno_hpersonalnomina.codnom, sno_hpersonalnomina.codded, sno_hpersonalnomina.codtipper,sno_hpersonalnomina.fecingper, MAX(sno_hpersonalnomina.codtabvac) AS codtabvac, ".

...
class sigesp_sno_c_metodo_banco
{
	...
	{ 	
	  	...
	  	switch ($as_metodo)
		{
			...
			case "BOD NUEVO":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_bod($as_ruta,$ac_codperi,$ad_fdesde,$ad_fhasta,$as_numref,$rs_data);
				break;
			...
			case "BANCO NACIONAL DE CREDITO":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_bnc($as_ruta,$rs_data,$ac_codperi,$ad_fdesde,$ad_fhasta,$ad_fecproc,$adec_montot,$as_codcueban);
				break;

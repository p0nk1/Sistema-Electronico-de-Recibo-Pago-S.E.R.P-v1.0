...
function uf_convertirddmmyyyy($as_fecha)
  {
	  ////////////////////////////////////////////////////////////////////////////////////////////////////////	   
...
function uf_convertiryyyymmdd($as_fecha)
  {
	  ////////////////////////////////////////////////////////////////////////////////////////////////////////	   
...
function mostrar_fecha_dmy($fecha)
	{
	//$fecha=date("d-m-Y H:i:s",strtotime($fecha));
	$fecha=date("d/m/Y H:i:s",strtotime($fecha));
	return $fecha;
	}
function mostrar_fecha_ymd($fecha)
	{
	//$fecha=date("d-m-Y H:i:s",strtotime($fecha));
 ...
 class class_funciones
 {
  ...
  function uf_formatovalidofecha($as_fecha)
  {
	  ...
	  //   Arguments:   $cadena: cadena, $catacter->caracter a ser rellenado , longitud de la cadena
	  ////////////////////////////////////////////////////////////////////////////////////////////////////////	 
	  $tmp_fecha = explode(" ",$as_fecha); //verificar si la fecha tiene formato DATETIME: YYYY-MM-DD 00:00:00
	  if (count($tmp_fecha)>1) 
	  	$as_fecha = $tmp_fecha[0];

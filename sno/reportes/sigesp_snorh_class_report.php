...
{
	//-----------------------------------------------------------------------------------------------------------------------------------
	function sigesp_snorh_class_report($ls_anocurso)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$this->io_conexion=$io_include->uf_conectar($ls_anocurso);
	...
	function uf_listadogenerico()
	{
		...
		if ($_SESSION["ls_criterio2"]==0)
		{
			$ls_sql="SELECT DISTINCT sno_personal.codper, ".$_SESSION["ls_campo"]." ".
					...
					" ORDER BY sno_personal.codper ";//.$_SESSION["ls_orden"]; 
//print $ls_sql;
		}
		else
		{
...
//****  Relacion Cargos 18-09-2012 ****//

function uf_relacioncargos_personal($codper)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_constanciatrabajo_personal
		//         Access: public (desde la clase sigesp_snorh_rpp_constanciatrabajo)  
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql="SELECT codemp, codnom, anocur, codperi, codper, codsubnom, codasicar, 
       			   codtab, codgra, codpas, sueper, horper, minorguniadm, ofiuniadm, 
				   uniuniadm, depuniadm, prouniadm, codcar, fecingper, fecegrper, 
				   fecculcontr, sueintper, sueproper, codded, codtipper, quivacper, 
				   codtabvac, pagefeper, pagbanper, codban, codcueban, tipcuebanper, 
				   cueaboper, codage, fecsusper, staper, cauegrper, codescdoc, codcladoc, 
				   codubifis, tipcestic, conjub, catjub, codclavia, codunirac, pagtaqper, 
				   grado, fecascper, descasicar, coddep, salnorper, estencper, obsrecper, 
				   anovig
			  FROM sno_thpersonalnomina WHERE codper like '%".$codper."%'";
